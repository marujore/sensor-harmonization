...
def harmonize(img_file, band, satsen, sensor_azimuth_name, sensor_zenith_name, solar_azimuth_name, solar_zenith_name, dir_out):
	...
	dst_ds = driver.Create( ('{}{}_RossThick.tif'.format(dir_out, name)), cols, rows, 1, gdal.GDT_Float32)
	...
	dst_ds = driver.Create( ('{}{}_LiSparce.tif'.format(dir_out, name)), cols, rows, 1, gdal.GDT_Float32)
	...
	dst_ds = driver.Create( ('{}{}_BRDFmask.tif'.format(dir_out, name)), cols, rows, 1, gdal.GDT_Float32)
	...
	dst_ds = driver.Create( ('{}{}_BRDF.tif'.format(dir_out, name)), cols, rows, 1, gdal.GDT_Float32)
	dst_ds.GetRasterBand(1).WriteArray(brdf)
	dst_ds.SetGeoTransform(geotrans)
	dst_ds.SetProjection(proj)
	dst_ds.GetRasterBand(1).SetNoDataValue(0)
	...
	dst_ds = driver.Create( ('{}{}_NBAR.tif'.format(dir_out, name)), cols, rows, 1, gdal.GDT_Float32)
...
def main():
	...
	# img_file = '{}{}'.format(dir_imgs, img_name)
	# dir_out = '/home/marujo/sensor_harmonization/out/'
	# band = 'red'
	# satsen = 'L8'
	# sensor_azimuth_file = '{}{}'.format(dir_imgs, 'LC08_L1TP_221069_20190425_20190508_01_T1_sensor_azimuth_band4.tif')
	# sensor_zenith_file = '{}{}'.format(dir_imgs, 'LC08_L1TP_221069_20190425_20190508_01_T1_sensor_zenith_band4.tif')
	# solar_azimuth_file = '{}{}'.format(dir_imgs, 'LC08_L1TP_221069_20190425_20190508_01_T1_solar_azimuth_band4.tif')
	# solar_zenith_file = '{}{}'.format(dir_imgs, 'LC08_L1TP_221069_20190425_20190508_01_T1_solar_zenith_band4.tif')
	# harmonize(img_file, band, satsen, sensor_azimuth_file, sensor_zenith_file, solar_azimuth_file, solar_zenith_file, dir_out)

	### Landsat data set ###
	# dir_imgs = '/home/marujo/sensor_harmonization/LC082150702018080201T1-SC20190731085329/'
	# img_name = 'LC08_L1TP_215070_20180802_20180814_01_T1_sr_band4.tif'
	# img_file = '{}{}'.format(dir_imgs, img_name)
	# dir_out = '/home/marujo/sensor_harmonization/out/'
	# band = 'red'
	# satsen = 'L8'
	# sensor_azimuth_file = '{}{}'.format(dir_imgs, 'LC08_L1TP_215070_20180802_20180814_01_T1_sensor_azimuth_B04.tif')
	# sensor_zenith_file = '{}{}'.format(dir_imgs, 'LC08_L1TP_215070_20180802_20180814_01_T1_sensor_zenith_B04.tif')
	# solar_azimuth_file = '{}{}'.format(dir_imgs, 'LC08_L1TP_215070_20180802_20180814_01_T1_solar_azimuth_B04.tif')
	# solar_zenith_file = '{}{}'.format(dir_imgs, 'LC08_L1TP_215070_20180802_20180814_01_T1_solar_zenith_B04.tif')
	# harmonize(img_file, band, satsen, sensor_azimuth_file, sensor_zenith_file, solar_azimuth_file, solar_zenith_file, dir_out)
	...
	band = 'red'
	satsen = 'S2SR_A'
	# sensor_azimuth_file = '{}{}'.format(dir_ang, 'S2A_OPER_MSI_L1C_TL_SGS__20190425T164208_A020055_T23LLF_Sat_B04_Azimuth_clip_resample.tif')
	sensor_azimuth_file = '{}{}'.format(dir_ang, 'vaa_snap.tif')
	sensor_zenith_file = '{}{}'.format(dir_ang, 'S2A_OPER_MSI_L1C_TL_SGS__20190425T164208_A020055_T23LLF_N02.07sensor_zenith_mean_resampled.tif')
	solar_azimuth_file = '{}{}'.format(dir_ang, 'S2A_OPER_MSI_L1C_TL_SGS__20190425T164208_A020055_T23LLF_N02.07solar_azimuth_resampled.tif')
	solar_zenith_file = '{}{}'.format(dir_ang, 'S2A_OPER_MSI_L1C_TL_SGS__20190425T164208_A020055_T23LLF_N02.07_solar_zenith_resampled.tif')
	harmonize(img_file, band, satsen, sensor_azimuth_file, sensor_zenith_file, solar_azimuth_file, solar_zenith_file, dir_out)
